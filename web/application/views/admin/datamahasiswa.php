  ...
  <script>
      ...
      var tabel = $("#tbl_mhs").DataTable({
          "responsive": true,
          "autoWidth": false,
          "ajax": "<?php echo base_url(); ?>admin/data-mahasiswa/json",
      ...
      function hapus(el) {
          ...
          swal({
              ...
              if (Hapuss) {
                  $.ajax({
                      url: "<?php echo base_url(); ?>admin/data-mahasiswa/destroy",
                      method: "POST",
                      data: {
                          nim: nim
                      },
      ...
      function tambah() {
          ...
          $.ajax({
              url: "<?php echo base_url(); ?>admin/data-mahasiswa/store",
              method: "POST",
              data: {
                  nama: nama,
                  id_pr: id_prodi,
      ...
      function filter(el) {
          ...
          $.ajax({
              url: "<?php echo base_url(); ?>admin/data-mahasiswa/filter",
              method: "POST",
              data: {
                  nim: nim
              },
      ...
      function update() {
          ...
          $.ajax({
              url: "<?php echo base_url(); ?>admin/data-mahasiswa/update",
              method: "POST",
              data: {
                  nim: nim,
                  nama: nama,
