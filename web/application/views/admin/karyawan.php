  ...
  <script>
      ...
      var tabel = $("#tbl_kry").DataTable({
          "responsive": true,
          "autoWidth": false,
          "ajax": "<?php echo base_url(); ?>admin/karyawan/json",
      ...
      function hapus(el) {
          ...
          swal({
              ...
              if (Hapuss) {
                  $.ajax({
                      url: "<?php echo base_url(); ?>admin/karyawan/destroy",
                      method: "POST",
                      data: {
                          no_id: no_id
                      },
      ...
      function tambah() {
          ...
          $.ajax({
              url: "<?php echo base_url(); ?>admin/karyawan/store",
              method: "POST",
              data: {
                  nama: nama_karyawan,
                  id_jbn: id_jabatan,
      ...
      function filter(el) {
          ...
          $.ajax({
              url: "<?php echo base_url(); ?>admin/karyawan/filter",
              method: "POST",
              data: {
                  no_id: no_id
              },
      ...
      function update() {
          ...
          $.ajax({
              url: "<?php echo base_url(); ?>admin/karyawan/update",
              method: "POST",
              data: {
                  no_id: no_id,
                  nama: nama,
