        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <table id="tbl_fk" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                    <th>No</th>
                    <th>Nama Fakultas</th>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
              <form>
                <div class="form-group">
                  <label>Nama Fakultas</label>
                  <input type="text" class="form-control" required placeholder="Masukkan Nama Fakultas" name="nama" id="nama">
                </div>                                    
            </div>
            <div class="modal-footer">
              <button type="reset" class="btn btn-secondary waves-effect waves-light">Reset</button>
...
<script>
              ...
              $.ajax({
                  ...
                  success: function(x){
                      ...
                      if(y == 1){
                          ...
                          if(y == 90){
                              swal({title: 'Hapus Gagal', text: 'Data Level Masih digunakan, Sehingga Tidak Dapat di Hapus Hanya Dapat di Ubah', icon: 'error'});
                              // refresh();
                          }else{
  ...
  function tambah(){
    ...
    var a = $("#nama").val();
    if(a == "" ){
        swal({title: 'Tambah Gagal', text: 'Nama Belum Anda Isi !', icon: 'error'});
        return;
    }
    swal("Memproses Data.....", {button: false, closeOnClickOutside: false, closeOnEsc: false});
    $.ajax({
