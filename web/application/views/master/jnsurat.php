              ...
              <div class="row">
                  <div class="col-12">
                      <div class="card">
                          ...
                          <!-- /.card-header -->
                          <div class="card-body">
                              <table id="tbl_jns" class="table table-bordered table-striped">
                                  <thead>
                                      <tr>
                                          <th>No</th>
  ...
  <script>
      ...
      var tabel = $("#tbl_jns").DataTable({
          "responsive": true,
          "autoWidth": false,
          "ajax": "<?php echo base_url(); ?>json_js",
